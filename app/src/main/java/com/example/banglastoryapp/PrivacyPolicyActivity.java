...
public class PrivacyPolicyActivity extends AppCompatActivity {
    ...
    String htmlText = "<h2>Privacy Policy</h2>" +
            "<p>DhakaDevCraft built the Global Language Translator app as a Free app. This service is provided by DhakaDevCraft at no cost and is intended for use as is.</p>" +
            "<p>This page is used to inform visitors regarding our policies with the collection, use, and disclosure of Personal Information if anyone decided to use our Service.</p>" +
            "<p>If you choose to use our Service, then you agree to the collection and use of information in relation to this policy. The Personal Information that we collect is used for providing and improving the Service. We will not use or share your information with anyone except as described in this Privacy Policy.</p>" +
            "<p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at Global Language Translator unless otherwise defined in this Privacy Policy.</p>" +
            ...
            "<p>We may update our Privacy Policy from time to time. Thus, you are advised to review this page periodically for any changes. We will notify you of any changes by posting the new Privacy Policy on this page. This policy is effective as of 2024-07-04.</p>" +
            "<h3>Contact Us</h3>" +
            "<p>If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us at <a href=\"mailto:globalLanguageTranslator22@gmail.com\">globalLanguageTranslator22@gmail.com</a>.</p>";
